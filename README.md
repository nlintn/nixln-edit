...
This tool allows quick & dirty editing of these files so you can find _just_ the right config values and are able to transfer these to your NixOS / home-manager configuration afterwards.
